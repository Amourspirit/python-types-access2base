...
src_path = str(HERE / 'access2baase')
...
setup(
    ...
    url="https://github.com/Amourspirit/python-types-access2base",
    packages=["access2base"],
    author=":Barry-Thomas-Paul: Moss",
    author_email='bigbytetech@gmail.com',
    license="Apache Software License",
    keywords=['libreoffice', 'openoffice', 'access2base', 'typings', 'uno', 'ooouno', 'pyuno'],
    classifiers=[
